...
public void keyPressed(KeyEvent ke) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_Y && keyspressed==4) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_F1 && keyspressed==6) {
		character.setLocation(800,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_F && keyspressed==7) {
		character.setLocation(900,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_SEMICOLON && keyspressed==8) {
