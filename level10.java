...
public void keyPressed(KeyEvent ke) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_P && keyspressed==4) {
		character.setLocation(600,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_O && keyspressed==5) {
		character.setLocation(700,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_0 && keyspressed==6) {
		character.setLocation(800,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_2 && keyspressed==7) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_X && keyspressed==9) {
