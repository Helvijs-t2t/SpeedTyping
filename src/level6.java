...
public void keyPressed(KeyEvent ke) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_Z && keyspressed==4) {
		character.setLocation(600,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_M && keyspressed==5) {
		character.setLocation(700,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_A && keyspressed==6) {
		character.setLocation(800,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_C && keyspressed==7) {
		character.setLocation(900,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_K && keyspressed==8) {
