...
public void keyPressed(KeyEvent ke) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_Q && keyspressed==5) {
		character.setLocation(700,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_5 && keyspressed==6) {
		character.setLocation(800,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_0 && keyspressed==7) {
		character.setLocation(900,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_1 && keyspressed==8) {
