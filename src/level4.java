...
public void keyPressed(KeyEvent ke) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_Q && keyspressed==4) {
		character.setLocation(600,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_CLOSE_BRACKET && keyspressed==5) {
		character.setLocation(700,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_G && keyspressed==6) {
		character.setLocation(800,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_5 && keyspressed==7) {
		character.setLocation(900,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_0 && keyspressed==8) {
		character.setLocation(1000,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_OPEN_BRACKET && keyspressed==9) {
