...
public class level10 implements KeyListener, ActionListener, Runnable {
	...
	JLabel backgroundPic = new JLabel(new ImageIcon(getClass().getResource("lvl10.png")));
	...
	public void keyPressed(KeyEvent ke) {
		...
		if (acceptInput) {
			if (ke.getKeyCode() == KeyEvent.VK_7 && keyspressed == 0) {
			...
			if (ke.getKeyCode() == KeyEvent.VK_J && keyspressed == 1) {
				character.setLocation(300, 550);
				keyspressed++;
			} else

			if (ke.getKeyCode() == KeyEvent.VK_T && keyspressed == 2) {
				character.setLocation(400, 550);
				keyspressed++;
			} else

			if (ke.getKeyCode() == KeyEvent.VK_Z && keyspressed == 3) {
				character.setLocation(500, 550);
				keyspressed++;
			} else if (ke.getKeyCode() == KeyEvent.VK_P && keyspressed == 4) {
				character.setLocation(600, 550);
				keyspressed++;
			} else if (ke.getKeyCode() == KeyEvent.VK_O && keyspressed == 5) {
				character.setLocation(700, 550);
				keyspressed++;
			} else if (ke.getKeyCode() == KeyEvent.VK_0 && keyspressed == 6) {
				character.setLocation(800, 550);
				keyspressed++;
			} else if (ke.getKeyCode() == KeyEvent.VK_2 && keyspressed == 7) {
	...
	public void goback() {
		if (VarCheck.disableCount == 9 && keyspressed > 9) {
