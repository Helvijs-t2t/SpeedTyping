...
public class level8 implements KeyListener, ActionListener, Runnable {
	...
	JLabel backgroundPic = new JLabel(new ImageIcon(getClass().getResource("lvl8.png")));
	...
	public void goback() {
		if (VarCheck.disableCount == 7 && keyspressed > 9) {
