...
public void keyPressed(KeyEvent ke) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_M && keyspressed==4) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_S && keyspressed==6) {
		character.setLocation(800,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_SEMICOLON && keyspressed==7) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_2 && keyspressed==9) {
...
public void goback() {
	if(VarCheck.disableCount==4 && keyspressed>9) {
