...
public void keyPressed(KeyEvent ke) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_F3 && keyspressed==5) {
		character.setLocation(600,550);
	
		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_OPEN_BRACKET && keyspressed==6) {
		character.setLocation(700,550);

		keyspressed++;
	}
	if(ke.getKeyCode()== KeyEvent.VK_Q && keyspressed==7) {
	...
	if(ke.getKeyCode()== KeyEvent.VK_F8 && keyspressed==9) {
